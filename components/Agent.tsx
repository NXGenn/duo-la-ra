...
const Agent = ({
  ...
  useEffect(() => {
    ...
    const handleGenerateFeedback = async (messages: SavedMessage[]) => {
      console.log("handleGenerateFeedback called with messages:", messages);
      ...
      if (messages.length === 0) {
        console.log("No messages to generate feedback from, redirecting to home");
        router.push("/");
        return;
      }
      ...
      try {
        ...
        if (success && id) {
          console.log("Redirecting to feedback page:", `/interview/${interviewId}/feedback`);
